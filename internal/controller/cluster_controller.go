...
//+kubebuilder:rbac:groups=api.core.clusterop.io,resources=clusters,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=api.core.clusterop.io,resources=clusters/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=api.core.clusterop.io,resources=clusters/finalizers,verbs=update
